          ...
          <FadeIn key={exp.year} delay={i * 0.1}>
            <div className="relative border-t border-border py-10 md:py-14 grid grid-cols-1 md:grid-cols-12 gap-4 items-baseline">
              ...
              <div className="md:col-span-2">
                <span className="font-sans text-sm font-light text-muted-foreground">{exp.year}</span>
              </div>
              <div className="md:col-span-5">
                <h3 className="font-serif text-xl md:text-2xl font-medium text-foreground">{exp.role}</h3>
              </div>
              <div className="md:col-span-5 md:text-right">
                <span className="font-sans text-sm font-light text-muted-foreground">{exp.place}</span>
              </div>
            </div>
          </FadeIn>
        ))}
